            ...
            <div class="header-main container">
                ...
                <div class="info col-md-8 col-sm-8">
                    <ul class="menu-top navbar-right hidden-xs">
                        ...
                        <li><a href=".php.php">Contact</a></li>
                    </ul><!--//menu-top-->
                    <br />
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active nav-item"><a href=".php.php">Contact Us</a></li>
...
<div class="col-lg-12" style="margin-top:10px;">
    ...
    <div class="col-lg-8 text-capitalize wrapper">
        <p>
                       ...
                       <ul>
                           <p style="font-weight:300;"><li><span><?php echo strtoupper("Newera Express Services");?> LLC</</span></li></p>
  						
                           <p><li><span>89 joseph Grishashvili street</span></li></p>
  						
                           <p><li><span>kutaisi 4600, Georgia.</span></li></p>
  						
                           <p><li><span>E-mail : Contact@neweracourierexpress.com</span></li></p>

  						   <p><li><span>Website : <a href="Home.php">http://neweracourierexpress.com</a> </span></li></p>
            ...
            <div class="container">
                ...
                <div class="footer-col col-md-3 col-sm-4 about">
                    <div class="footer-col-inner">
                        <h3>About</h3>
                        <ul id="ulSiteInfo">
                            <li><a href="Default.php"><i class="fa fa-caret-right"></i>Home</a></li>
                            <li><a href="Aboutus.php"><i class="fa fa-caret-right"></i>Aboutus</a></li>
                            <li><a href=".php.php"><i class="fa fa-caret-right"></i>Contact Us</a></li>
