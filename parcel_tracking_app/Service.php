            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active nav-item"><a href="Service.php">Services</a></li>

                        <li class="nav-item"><a href="Contactus.php">Contact Us</a></li>

                        <li class="nav-item"><a href="Enquiry.php">Enquiry</a></li>
                    </ul><!--//nav-->
                </div><!--//navabr-collapse-->
            </div><!--//container-->
        </nav><!--//main-nav-->
...
<div class="col-lg-12" style="margin-top:10px;">
    <div class="col-lg-4">
        ...
        <img class="img-responsive img-thumbnail" src="images/6.jpg" />
    </div>

    <div class="col-lg-8 text-capitalize wrapper">
        <p>

                       <ul>
                           <p style="font-weight:300;"><li><span>International document and non-document delivery</span></li></p>
  						
                           <p><li><span>Domestic document and non-document delivery</span></li></p>
  						
                           <p><li><span>Express delivery</span></li></p>
  						
                           <p><li><span>Same day delivery across regions we serve</span></li></p>

  						   <p><li><span>Bullet service to all over the globe </span></li></p>
  						
                           <p><li><span>Cheque collections</span></li></p>
  						
                           <p><li><span>Prepaid voucher service</span></li></p>
  						
                           <p><li><span>Monthly credit statement for selected customers</span></li></p>
  						
                           <p><li><span>Return services</span></li></p>
