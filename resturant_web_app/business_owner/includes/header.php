...
<head>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index-2.html" class="logo"> <span> Maxpychannel </span></a>
                    </div>
                </div>
            ...
            <!-- ========== Left Sidebar Start ========== -->
            <?php
                         echo '<input type="hidden" value = "'.$_SESSION['busines_owner_id'].'" id="busines_owner_id">';
            ?>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src=""  id="admin_image" alt="" class="thumb-md img-circle">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" id="admin_name"></a>
                                <!-- <ul class="dropdown-menu">
                                   <li><a href="business_owner_profile.php"><i class="md md-settings"></i> Settings</a></li>
                                        <li><a href="logout.php"><i class="md md-settings-power"></i> Logout</a></li>
                                </ul> -->
                            </div>
                            
                            <p class="text-muted m-0">Business Owner</p>
                        </div>
                    </div>
                    <!--- Divider -->
                    <div id="sidebar-menu">
                        ...
                        <!--     <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-mail"></i><span> Membership Packages </span><span class="pull-right"><i class="md md-add"></i></span></a>
                             ...
                             <li id="membership_page_list" class="hider">
                                <a href="all_membership_packages.php" class="waves-effect"><i class="md md-mail"></i><span> Membership Packages </span></a>
                            </li>
                           ...
                           <!--  
                            ...
                            <!-- <li class="has_sub">
                             ...
                             <li>
                                <a href="business_owner_profile.php" class="waves-effect"><i class="md md-settings"></i><span> Profile Settings </span></a>
                            </li>
                            <li>
