                    ...
                    <div class="container">
                        ...
                        <div class="row">
                               <?php
                                    ...
                                    show_back_button("add_drinks_for_event.php?business_id=".$business_id,"Back To Event Drinks");
                                ?>
                            <div class="col-md-12">
                                               <?php
                                                    
                                                    $check = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=10"); # for events-                                                    
