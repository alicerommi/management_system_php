                    ...
                    <div class="container">
                        ...
                        <div class="row">
                               <?php
                                    ...
                                    show_back_button("add_adult_entertanmaint_drinks.php?business_id=".$business_id,"Back To Adult Entertainment Drinks");
                                ?>
                            <div class="col-md-12">
                            	               <?php
							                                    ...
							                                    <div class="panel-body">
							                                    		...
							                                    		<form action="actions/update.php" method="post" enctype="multipart/form-data">
                                                                               ...
                                                                               <!--      <label>Menu Details</label> -->
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <button type="submit" name="update_adult_entertanment_drinks" class="btn btn-success">Update Drink Details</button>
                                                                                </div>
