                    ...
                    <div class="container">
                        ...
                        <div class="row">
                               <?php
                                    ...
                                    show_back_button("add_concert_drinks.php?business_id=".$business_id,"Back To Concert Drinks");
                                ?>
                            <div class="col-md-12">
                            	               <?php
                                    				
                                    				$check = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=7"); # for concert
