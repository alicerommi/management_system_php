                    ...
                    <div class="container">
                        ...
                        <div class="row">
                               <?php
                                    ...
                                    show_back_button("add_resturant_menus.php?business_id=".$business_id,"Back To Resturant Menus");
                                ?>
                            <div class="col-md-12">
                            	               <?php
                                    				
                                    				$check_business_resturant = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=1"); # for resturant
                                                    ...
                                                    <div class="col-md-12">
                                                        <?php
                                                              if(isset($_GET['udpated_menu'])){
                                                                    if($_GET['udpated_menu']==1)
                                                                         messages("The Menu Details Has Been Updated","success");
                                                                    else if($_GET['udpated_menu']==0)
							                                    ...
							                                    <div class="panel-body">
							                                    		...
							                                    		<form action="actions/update.php" method="post" enctype="multipart/form-data">
                                                                               ...
                                                                               <!--      <label>Menu Details</label> -->
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <button type="submit" name="update_resturant_menus" class="btn btn-success">Update Menu</button>
                                                                                </div>
