                            ...
                            <div class="col-md-12">
                            	<?php
                                                    ...
                                                    if(isset($_GET['added_details'])){
                                                        ...
                                                        if ($g==1){
                                                              messages("Business Details has been added","success");
                                                        }else if($g==0){
                                    				...
                                    				?>	<div class="panel panel-default">
							                                    <div class="panel-heading">
							                                        <h3 class="panel-title">1) Add Businesss Pictures</h3>
							                                    </div>
							                                    <div class="panel-body">
							                                    	<div class="col-md-12">
							                                    		<form action="actions/insert.php" method="post" enctype="multipart/form-data">
							                                    			<div class="form-group">	
							                                    				<label>Upload Businesss Images</label>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h3 class="panel-title">3) Add Businesss Details</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <div class="col-md-12">
                                                             ...
                                                             <div class="panel panel-default">
                                                                ...
                                                                ?>
                                                                <div class="panel-heading">
                                                                    <h3 class="panel-title">4) Add Businesss Videos</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <div class="col-md-12">
