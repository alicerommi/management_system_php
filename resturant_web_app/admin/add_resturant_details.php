                            	...
                            	<?php
                                     ...
                                     //    </div>';
                                        ...
                                        if(isset($_GET['added_details'])){
                                            ...
                                            if ($g==1){
                                                  messages("Resturant Details has been added","success");
                                            }else if($g==0){
                                                messages("Error in adding Resturant Details","warning");
                                            }
                                        }
                                    				...
                                    				?>	<div class="panel panel-default">
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h3 class="panel-title">3) Add Restaurant Details</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <div class="col-md-12">
                                                             ...
                                                             <div class="panel panel-default">
                                                                ...
                                                                ?>
                                                                <div class="panel-heading">
                                                                    <h3 class="panel-title">4) Add Restaurant Videos</h3>
                                                                </div>
                                                                <div class="panel-body">
                                                                    <div class="col-md-12">
