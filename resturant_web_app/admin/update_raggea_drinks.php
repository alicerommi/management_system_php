                    ...
                    <div class="container">
                        ...
                        <div class="row">
                               <?php
                                    ...
                                    show_back_button("add_raggea_drinks.php?business_id=".$business_id,"Back To Raggea Drinks");
                                ?>
                            <div class="col-md-12">
                            	               <?php
                                    				
                                    				$check = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=9"); # for raggea-                                                    
