                    ...
                    <div class="container">
                        ...
                        <div class="row">
                               <?php
                                    ...
                                    show_back_button("add_bar_menus.php?business_id=".$business_id,"Back To Bar Drinks");
                                ?>
                            <div class="col-md-12">
                            	               <?php
                                    				
                                    				$check = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=2"); # for bar
                                                    ...
                                                    <div class="col-md-12">
                                                        <?php
                                                              ...
                                                              $dir_menus = "../uploads/drinks_images/";
                                                                ...
                                                                $fetch_drink_details = mysqli_query($conn,"select* from business_bar_drinks where admin_business_id= $business_id and business_bar_drink_id = $drink_id");
							                                    ...
							                                    <div class="panel-body">
							                                    		...
							                                    		<form action="actions/update.php" method="post" enctype="multipart/form-data">
                                                                               ...
                                                                               <!--      <label>Menu Details</label> -->
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <button type="submit" name="update_bar_drinks" class="btn btn-success">Update Drink Details</button>
                                                                                </div>
