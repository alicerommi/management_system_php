                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                            	<?php
                                    				...
                                    				$check_business_bar = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=9"); # for raggea
