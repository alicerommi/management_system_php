                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="panel panel-default">
							                                    <div class="panel-heading">
							                                        <h3 class="panel-title">Add Menus For Resturant</h3>
							                                    </div>
							                                    		...
							                                    		<form action="actions/insert.php" method="post" enctype="multipart/form-data">
                                                                               ...
                                                                               <!--      <label>Menu Details</label> -->
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <button type="submit" name="save_resturant_menus" class="btn btn-success">Save Menu</button>
                                                                                </div>
