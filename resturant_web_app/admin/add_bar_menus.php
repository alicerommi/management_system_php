                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                            	<?php
                                    				...
                                    				$check_business_bar = mysqli_query($conn,"SELECT * FROM `admin_added_business` where business_id= $business_id  and business_type=2"); # for bar
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="panel panel-default">
							                                    <div class="panel-heading">
							                                        <h3 class="panel-title">Add Drinks For Bar</h3>
							                                    </div>
							                                    		...
							                                    		<form action="actions/insert.php" method="post" enctype="multipart/form-data">
                                                                               ...
                                                                               <!--      <label>drink Details</label> -->
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <button type="submit" name="save_bar_drinks" class="btn btn-success">Save Drink</button>
                                                                                </div>
