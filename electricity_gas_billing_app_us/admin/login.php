...
<head>
        <meta charset="utf-8" />
         <title>Save Energy Admin Panel</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
  <meta content="TRAIN ACTIVATE UNLEASH  http://Binary6.co" name="description" />
        <meta content="TRAIN ACTIVATE UNLEASH" name="author" />
