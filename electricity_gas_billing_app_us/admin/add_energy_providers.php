            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <?php
                            show_button("all_energy_providers.php","View All Gas Suppliers","info","eye");
                            ...
                            ?>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Add Energy Suppliers Details</h3>
                                        </div>
                                            ...
                                            <form method="post" action= "actions/insert.php" enctype="multipart/form-data">
                                                <div class="col-md-6">
                                                 <!-- <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <button class="btn btn-success pull-right" type="submit" name="add_new_energy_provider">Save</button>
                                                    </div>
