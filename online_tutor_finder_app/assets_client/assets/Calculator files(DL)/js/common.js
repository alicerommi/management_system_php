...
$(document).ready(function() {$(document).on("scroll", function(e) {if ($(this).scrollTop() > 100) {$("#wrap").addClass("fix-search");} else {$("#wrap").removeClass("fix-search");}});window.onresize = navigationResize;if ($('#nav').length){navigationResize();}});
