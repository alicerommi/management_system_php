        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class ="container">
                   ...
                   $query=mysqli_query($con,"SELECT * FROM animation");
                   ...
                   ?>
                        ...
                        <a href = "formcontrol.php?id=<?php echo $id; ?>" ><h2><?php echo $title; ?></h2></a>
                        <img style = "width: 200px; height: 200px;" class ="img-responsive" src="<?php echo $pic; ?>"/>
                        </div>
