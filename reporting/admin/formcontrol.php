...
<head>
    ...
    <title>Admin | 800creditnow</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.html"><b><img src="../plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>800</strong>creditnow</span></a></div>
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <!--<li class="user-pro">
                        <a href="#" class="waves-effect"><img src="../plugins/images/users/d1.jpg" alt="user-img" class="img-circle"> <span class="hide-menu">Admin<span class="fa arrow"></span></span>
                        </a>
                 ...
                 <!--   <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-envelope p-r-10"></i> <span class="hide-menu"> Mailbox <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">6</span></span></a>
                    ...
                    <li class="nav-small-cap m-t-10">--- Leads</li>
                    <li><a href="formcontrol.php">Cartoons</a></li>
            ...
            <span class="fa arrow"></span></a>
                    ...
                    <li><a href="leads.php">Leads/Users</a></li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats"> <i class="ti-user bg-megna"></i>
                                <div class="bodystate">
                                    <h4>0</h4> <span class="text-muted">Leads</span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats"> <i class="ti-shopping-cart bg-info"></i>
                                <div class="bodystate">
                                    <h4>0</h4> <span class="text-muted">Purchases</span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats"> <i class="ti-wallet bg-success"></i>
                                <div class="bodystate">
                                    <h4>0</h4> <span class="text-muted">Subscriptions</span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats"> <i class="ti-wallet bg-inverse"></i>
                                <div class="bodystate">
                                    <h4>$0</h4> <span class="text-muted">Earning</span> </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php include "../includes/config.php";
                    ...
                    $query=mysqli_query($con,"SELECT * FROM animation where anim_id='$id'");
                    $data=mysqli_fetch_array($query);
                        $title=$data['anim_title'];
                        $path=$data['anim_path'];
                ...
                ?>
                   <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Update Cartoons</h3>
                            <p class="text-muted m-b-30 font-13"> Please fill in the information below </p>
                            <form class="form-horizontal" method = "post" action = "formcontrol.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-md-12">Title<span class="help"> e.g. "Tupac"</span></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name = "atitle" value="<?php echo $title; ?>">
                                        <input type="hidden" class="form-control" name = "animid" value="<?php echo $id; ?>"> </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                            ...
                                            <input type="file" name="cart" id="cart"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                <input type = "submit" class ="btn btn-rounded" name="cartoon"/>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                elseif(isset($_POST['cartoon'])){
                    $id=$_POST['animid'];
                    $atitle=$_POST['atitle'];

                    if(empty(basename($_FILES["cart"]["name"]))){
                        $query=mysqli_query($con, "UPDATE `animation` SET `anim_title`= '$atitle' WHERE anim_id = '$id' ");
                        if($query){ 
                            echo "The file has been updated";
                        }

                    }
                    elseif(!empty(basename($_FILES["cart"]["name"]))){

                        

$target_dir = "images/";
$target_file = $target_dir . basename($_FILES["cart"]["name"]);
$uploadOk = 1;
$imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);
// Check if image file is a actual image or fake image
if(isset($_POST["submit"])) {
    $check = getimagesize($_FILES["cart"]["tmp_name"]);
    if($check !== false) {
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["cart"]["tmp_name"], $target_file)) {
        $query=mysqli_query($con,"UPDATE `animation` SET `anim_path`='$target_file',`anim_title`='$atitle' WHERE anim_id = '$id' ");
        if($query){ 
        echo "The file ". basename( $_FILES["cart"]["name"]). " has been updated";
    }
    } else {
