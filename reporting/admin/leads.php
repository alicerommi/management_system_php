        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                 ...
                 <!--   <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-envelope p-r-10"></i> <span class="hide-menu"> Mailbox <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">6</span></span></a>
                    ...
                    <li><a href="cartoons.php">Cartoons</a></li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Leads Table</h3>
                            <p class="text-muted m-b-20">Showing the number of users who have submitted the qualify form</p>
                            <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                <thead>
                                    <tr>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Name</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">Lead Email Address</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">Lead Phone</th>
                                    
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">Delete</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    
                                    <?php include "../includes/config.php";
                                    $query=mysqli_query($con,"SELECT * from leads order by lead_id desc");
                                    while($data=mysqli_fetch_array($query)){ 
                                        ...
                                        ?>
                                        <tr>
                                    <td class="title"><a href="javascript:void(0)"><?php echo $lead_name; ?></a></td>
                                        <td><?php echo $lead_email; ?></td>
                                        <td><?php echo $lead_phone; ?></td>
                                        <td><a href="actions/delete.php">Delete</a></td>
                                        </tr>
                                    <?php } ?>
