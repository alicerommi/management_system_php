        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                 ...
                 <!--   <li> <a href="javascript:void(0);" class="waves-effect"><i class="icon-envelope p-r-10"></i> <span class="hide-menu"> Mailbox <span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">6</span></span></a>
                    ...
                    <li><a href="form-basic.html">Cartoons</a></li>
                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-12"><?php echo $title; ?><span class="help"> e.g. "Tupac"</span></label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                            ...
                                            <input type="file" name="cartoon"> </span> <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a> </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
