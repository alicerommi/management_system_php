...
if(isset($_POST['addDealer'])){
	...
	$query=mysqli_query($con,"INSERT INTO dealers(dealer_name,dealer_email,dealer_password,dealer_code) VALUES('$name','$email','$pw','$dealercode')");
	if($query){
