        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Existing Surveys Table</h3>
                            <p class="text-muted m-b-20">Showing the number of surveys currently existing in the database</p>
                            <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">End Date</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">Status</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">Add Questions</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">Details</th>
                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">See Resuts</th>
                                ...
                                <tbody>
                                    ...
                                    $query=mysqli_query($con,"SELECT * from survey_new order by survey_id desc");
                                    while($data=mysqli_fetch_array($query)){ 
                                        $id=$data['survey_id'];
                                        $su_name=$data['survey_title'];
                                        $su_start=$data['survey_start'];
                                        $su_end=$data['survey_end'];
                                        $status=$data['survey_status'];
                                        ?>
                                        <tr>
                                    <td class="title"><a href="javascript:void(0)"><?php echo $su_name; ?></a></td>
                                        <td><?php echo $su_start; ?></td>
                                        <td><?php echo $su_end; ?></td>
                                        <td><?php echo $status; ?></td>
                                        <td><a href="add-questions.php?id=<?php echo $id; ?>">Add Questions</a></td>
                                        <td><a href="existing-questions.php?id=<?php echo $id; ?>">View Details</a></td>
                                        <td><?php echo 'Under Construction'; ?></td>
                                        <td><a href="actions/delete.php?id=<?php echo $id; ?>">Delete</a></td>
                                        </tr>
                                    <?php } ?>
