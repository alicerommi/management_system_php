...
$('#pagination').on('click', 'a', function(e) { // When click on a 'a' element of the pagination div
	...
	$('#articleArea').html('<img src="user_comments/design/loader-small.gif" alt="" />'); // Display a processing icon
	var data = {page: page, per_page: 5}; // Create JSON which will be sent via Ajax
	// We set up the per_page var at 4. You may change to any number you need.
	$.ajax({ // jQuery Ajax
		type: 'POST',
		url: 'user_comments/ajax/tuto-pagination.php', // URL to the PHP file which will insert new value in the database
