                                  ...
                                  <table id="allrequests" class="display nowrap dataTable" cellspacing="0" width="100%"  style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $query = "SELECT* FROM `schedule_bookings` WHERE ins_id=$ins_id";
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                ...
                                                echo' <span class="label label-danger label-rouded">Disapproved</span>';
                                                     ...
                                                     echo' <span class="label label-info label-rouded">Pending</span>';
                                                }
                                            ?>
                                            </td>
                                             <td><?php 
                                           // echo '<a href="userInfo.php?userID='.$userID.'"></a>';
                echo '<a class="btn btn-block btn-default" href="learner-profile.php?learner_id='.$userID.'">Profile</a>';
                                            ?></td>
                                        </tr>
                                <?php 
