...
<script>
 ...
 {
      $("#messages").load("chatFiles/load.php?ins_id="+senderID+"&user_id="+recieverID).show();
       scrollNow();
                               ...
                               <center> <h3>All Users</h3></center><hr/>
                                   ...
                                   $query = mysqli_query($conn,"SELECT* FROM `instructor` WHERE email='$ins_email'");
                                       ...
                                       // $instructorName = $row['name'];
                                        $instructorID= $row['id']; //which is the insteructor id 
                                             //to get the all the learner 
                                        echo '<input type="hidden" id="instructorID" value='.$instructorID.'>';
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click','.usersClicked',function(){
               ...
               var dataString = "user_id="+userID+"&ins_id="+instructorID;
               $.ajax({
