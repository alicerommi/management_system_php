                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                           ...
                           <li><a>My Payments</a></li>
                            <li class="active">Send Payment Request</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                      <div class="col-lg-12">
                        <div class="panel panel-success">
                             <div class="panel-heading">Send Payment Request To User</div> 
                                            ...
                                            <div id="example23_wrapper" class="dataTables_wrapper">
                                              <table id="allrequests" class="display nowrap dataTable" cellspacing="0" width="100%"  style="width: 100%;">
                                                ...
                                                <tr >     
 													...
 													echo '<a class="btn btn-block btn-default" href="userInfo.php?userID='.$userID.'">View Profile</a>';
                                                        ?></td>
                                                       ...
                                                       # echo '<button type="button" class="btn btn-default btn-circle waves-effect accept" name='.$schdule_ID.'><i class="fa fa-check"></i> </button>';
                                                        ...
                                                        <td>
                                                        <?php  #echo '<button type="button" class="btn btn-warning btn-circle waves-effect reject" name='.$schdule_ID.'><i class="fa fa-times"></i> </button>';
                                                            ?>
                                                        </td>
