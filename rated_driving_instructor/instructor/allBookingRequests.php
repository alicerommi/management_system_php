    ...
    <div id="wrapper">
        ...
        <!-- Page Content -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            <li><a href="index.php">Booking Requsts</a></li>
                            <li class="active">All Booking Requests</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
            ...
            <div class="panel panel-default">
                    <div class="panel-heading">View All Booking Requests</div> 
                                  ...
                                  <table id="allrequests" class="display nowrap dataTable" cellspacing="0" width="100%"  style="width: 100%;">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $query = "SELECT* FROM `schedule_bookings` WHERE ins_id=$id";
                                            ...
                                            if(mysqli_num_rows($result)>0){
                                                while($record = mysqli_fetch_array($result)){
                                                    ...
                                                    $approvedStatus = $record['approvedStatus'];
                                                        ...
                                                        echo '<tr id="schduleRow'.$schdule_ID.'">';
                                        ?>
                                            ...
                                            <td>
                                                ...
                                                if($approvedStatus==1){
                                                    ...
                                                    if($approvedStatus!=2){
                                            echo '<button type="button" class="btn btn-default btn-circle waves-effect accept" name='.$schdule_ID.'><i class="fa fa-check"></i> </button>';
                                                    }
                                                }
                                            ?>
                                            </td>
                                            ...
                                            if($approvedStatus==2){
                                               //  echo 'Rejected';
                                                ...
                                                if($approvedStatus!=1){
                                            echo '<button type="button" class="btn btn-warning btn-circle waves-effect reject" name='.$schdule_ID.'><i class="fa fa-times"></i> </button>';
                                                    }
                                                 }
                                                ?>
                                            </td>
        ...
        $(document).ready(function(){
            //for accept button
             $(document).on('click','.accept',function(){
                var schdule_ID =$(this).attr('name');
                var action = "accept";
                var dataString = "schdule_ID="+schdule_ID+"&action="+action;
                $.ajax({
                    method:"POST",
                    ...
                    success:function(){
                        alert("The Request has been Accepted");
                         location.reload();
                        //$("#schduleRow1"+schdule_ID).hide();
                        // $('#allrequests').DataTable().reload();
                    ...
                    $.ajax({
                        ...
                        success:function(){
                                    alert("The Request has been Rejected");
                                     location.reload();
                          //  $("#schduleRow1"+schdule_ID).fadeOut("Slow");
                            //$('#allrequests').DataTable().reload();
